...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		maze = ImageIO.read(getClass().getResource("border.png"));
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("patrick.wav"));
	...
	private void showScaryImage(String spooky) {
		try {
			maze = ImageIO.read(getClass().getResource(spooky));
		} catch (Exception e) {
			System.err.println("Couldn't find this image: " + spooky);
		}
		repaint();
	}
